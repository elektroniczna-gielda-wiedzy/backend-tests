...
class CategoryService:
    ...
    def list(self):
        ...
        return requests.get(url=list_url, headers={"Authorization": self.auth_token}, timeout=TIMEOUT_SECONDS)
    ...
    def update(self, category_id, **kwargs):
        ...
        return requests.put(url=update_url, json=kwargs, headers={"Authorization": self.auth_token}, timeout=TIMEOUT_SECONDS)
